...
#include <dvl_sensor_ros_plugin/Common.hh>
#include <ros/ros.h>
#include <std_msgs/Bool.h>
#include <dvl_msgs/ChangeSensorState.h>
...
namespace gazebo
{
  class ROSBasePlugin
  {
    ...
    protected: bool ChangeSensorState(
        dvl_msgs::ChangeSensorState::Request& _req,
        dvl_msgs::ChangeSensorState::Response& _res);
