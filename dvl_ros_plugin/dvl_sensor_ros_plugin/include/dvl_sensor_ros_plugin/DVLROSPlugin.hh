...
#include <dvl_sensor_ros_plugin/ROSBaseModelPlugin.hh>
#include <dvl_msgs/DVL.h>
#include <dvl_msgs/DVLBeam.h>
...
namespace gazebo
{
  ...
  class DVLROSPlugin : public ROSBaseModelPlugin
  {
    ...
    protected: dvl_msgs::DVL dvlROSMsg;

    protected: std::vector<dvl_msgs::DVLBeam> dvlBeamMsgs;
